...
volatile uint edit_time = 0; // 0: n�o faz nada | 1: edita min | 2: edita hora
...
/**
 * \brief Muda a vari�vel edit_time definida para:
...
static void down_handler(lv_event_t *e)
{
  ...
  char *c;
  int temp;
  /* Quando o bot�o � pressionado e edit_time=1, altera minuto */
  ...
  /* Quando o bot�o � pressionado e edit_time=2, altera hora */
  ...
  /* Quando o bot�o � pressionado e edit_time=0, altera temperatura */
